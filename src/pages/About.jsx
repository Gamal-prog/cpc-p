                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 mb-6">
                            Over 6 million free high-resolution photos and illustrations brought to you by the world’s
                            most generous community of contributors.
                        </p>
                        <Link to="/">
                ...
                <div className="max-w-7xl mx-auto py-12 px-6 ">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 mb-6">
                                Seeglance is a platform powered by an amazing community that has
                            ...
                            <button className="btn btn-primary">
                                Learn more about the Seeglance License
                            </button>
                        </div>
                    </div>
            ...
            <div className="max-w-7xl mx-auto py-12 px-6">
                ...
                <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    <div>
                        ...
                        <p className="text-gray-600 mb-6">
                            Seeglance was born from the pain we had in finding great, usable
